    ...
    <div className="flex justify-center items-center h-screen flex-col">
      <div className="flex flex-col gap-4 items-center justify-center h-44">
        ...
        <button
          ...
          className="bg-green-600 rounded-full text-black w-12 h-12 cursor-pointer hover:scale-110 duration-200 border-2 border-transparent hover:border-white flex items-center justify-center"
        >
          {"--->"}
        </button>
        ...
        <div onClick={() => {router.replace("/auth")}} className=" mt-24 font-thin italic cursor-pointer hover:text-red-600 duration-200 hover:underline">
